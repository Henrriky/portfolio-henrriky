...
function Contact() {
    ...
    const sendEmail = (event) => {
        ...
        emailjs.sendForm('service_2tz5vsk', 'template_nw56d24', form.current, 'MHa2-7vvQR0-UUs69');
        event.target.reset();
    ...
    return (
        <section className="contact section" id="contact">
            ...
            <span className="section__subtitle">Me chame</span>
            ...
            <div className="contact__container container grid">
                <div className="contact__content">
                    ...
                    <div className="contact__info">
                        ...
                        <div className="contact__card">
                            ...
                            <span className="contact__card-data">11954056219</span>
                            <a href="https://api.whatsapp.com/send?phone=11954056219&text=Olá tudo bem?" className="contact__button">
                                Mande uma mensagem {" "}
                                <i className="bx bx-right-arrow-alt contact__button-icon"></i>
                            </a>
                        </div>
                ...
                <div className="contact__content">
                    <h3 className="contact__title">Fale sobre o motivo do contato</h3>
